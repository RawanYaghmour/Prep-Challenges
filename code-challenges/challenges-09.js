...
const employeesBonus = (arr) => {
    ...
    arr.forEach(employee => {
        if (employee.section === "Production") {
            if (employee.workHours > 8) {
                // Add $100 bonus for working more than 8 hours
                employee.salary = `${parseInt(employee.salary) + 100}$`;
            } else {
                // Add $50 bonus for working 8 hours or less
...
const mostExpensive = (budget, mouseArray, keyBoardArray) => {
    ...
    for (let mousePrice of mouseArray) {
        ...
        for (let keyBoardPrice of keyBoardArray) {
            ...
            // If the total price is within budget and greater than current maxPrice, update maxPrice
